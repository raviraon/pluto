...
$sql = "SELECT fusion_id, campaign, customer_name, open_date, close_date, status, created_at, updated_at, comments FROM case_details WHERE fusion_id = '$fusion_id' ORDER BY updated_at DESC";
